...
public class TransactionTest {
	...
	@Test
	public void receiveBlock() throws QlcException, IOException {
    	...
    	JSONObject sendBlockJson = TransactionMng.sendBlock(from, tokenName, to, amount, null, null, null, Helper.hexStringToBytes(privateKey));
		...
		JSONObject receiveBlockJson = TransactionMng.receiveBlock(new Gson().fromJson(sendBlockJson.toJSONString(), StateBlock.class), Helper.hexStringToBytes(priKey));
